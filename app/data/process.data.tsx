...
export const processItems: ListItem[] = [
  {
    ...
    text: 'Whatever your goal is, we want to hear about it and see if we can help you find a creative solution to achieve it.'
  },
  {
  ...
  },
  {
    ...
    text: 'When we have a version of the project that satisfies all of your requirements, we will put it through its paces and send it back to you for comments and revisions.'
  },
  {
